...
const userName = ref("John Doe"); // Static user's name
const userType = ref("Admin"); // Static user type
const userAvatar = ref("/images/avatar.avif"); // Static avatar path
...
onMounted(() => {
  ...
  // Static user information assignment
  userName.value = "John Doe"; // Static name
  userType.value = "Admin"; // Static type
  userAvatar.value = "/images/avatar.avif"; // Static avatar
